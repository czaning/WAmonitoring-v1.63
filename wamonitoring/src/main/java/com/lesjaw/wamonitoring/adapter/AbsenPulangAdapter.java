...
public class AbsenPulangAdapter extends RecyclerView.Adapter<AbsenPulangAdapter.MainViewHolder> {
    ...
    public AbsenPulangAdapter(List<AbsenceModel> nodeList, Context mContext) {
    ...
    public void onBindViewHolder(MainViewHolder holder, int position) {
        ...
        holder.workingHours.setText(adString);

        String input = mEmployeeModel.getDate_created();
        String output = mEmployeeModel.getDate_created_pulang();
        ...
        try {
            ...
            long dura = updatetime1 - updatetime;
            holder.lokasi.setText("Working time "+Utils.getDuration(dura/1000) +", range from working location when "+
                    mEmployeeModel.getEmployee_name()+" go home is "+
                    Utils.getJarak(Integer.parseInt(mEmployeeModel.getRange_loc())));
            holder.tgl.setText("Clock IN "+simpleDateFormat2.format(updatetime)+"\nClock OUT "+simpleDateFormat2.format(updatetime1));

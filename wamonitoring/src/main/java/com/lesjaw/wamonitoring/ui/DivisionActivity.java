...
public class DivisionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        but_add.setOnClickListener(view -> {
            ...
            pDialog = new ProgressDialog(DivisionActivity.this);
    ...
    private void editData (String pid, String name){
        ...
        final EditText eName = new EditText(DivisionActivity.this);
        eName.setHint("Division name");
        eName.setText(name);
        new AlertDialog.Builder(DivisionActivity.this)
                ...
                try {
                    ...
                    JSONArray cast = jsonResponse.getJSONArray("division");
                        ...
                        adapter = new SimpleAdapter(
                                DivisionActivity.this, divisionList,

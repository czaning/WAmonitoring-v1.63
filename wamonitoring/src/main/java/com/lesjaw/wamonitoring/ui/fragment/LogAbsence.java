...
import com.lesjaw.wamonitoring.adapter.AbsenAdapter;
...
public class LogAbsence extends android.support.v4.app.Fragment {

    private SharedPreferences sharedPref;
    private static final String TAG = "LogAbsence";
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mAdapter = new AbsenAdapter(tagList, mContext);
                ...
                if (result_code.equals("1")) {
                    ...
                    for (int i = 0; i < cast.length(); i++) {
                        ...
                        AbsenceModel tags = new AbsenceModel(employee_name, email,
                                date_created,"", latitude, longitude, working_gps, log_status, phone1, phone2,range_loc);

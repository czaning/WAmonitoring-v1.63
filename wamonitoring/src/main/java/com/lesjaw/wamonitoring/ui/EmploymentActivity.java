...
public class EmploymentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lac_activity.setText("company employment");
        lab_division.setHint("type employment name");
        ...
        but_add.setOnClickListener(view -> {
            ...
            pDialog = new ProgressDialog(EmploymentActivity.this);
    ...
    private void editData (String pid, String name){
        ...
        final EditText eName = new EditText(EmploymentActivity.this);
        ...
        new AlertDialog.Builder(EmploymentActivity.this)
                ...
                .setPositiveButton("Ok", (dialog, id) -> {
                    ...
                    String url = "https://olmatix.com/wamonitoring/update_employment.php";
                    StringRequest MyStringRequest = new StringRequest(Request.Method.POST, url, response -> {
                        ...
                        protected Map<String, String> getParams() {
                            ...
                            MyData.put("pid", pid);
                            MyData.put("employment_name", eName.getText().toString());
                            return MyData;
                        }
                    };
                ...
                .setNegativeButton("Delete", (dialog, id) -> {
                    ...
                    String url = "https://olmatix.com/wamonitoring/delete_employment.php";
                    StringRequest MyStringRequest = new StringRequest(Request.Method.POST, url, response -> {
                        Log.d(TAG, "onResponse: "+response);
                        parsingJson(response);
                        Log.d(TAG, "sendJsonLogin: "+response);
    ...
    private void sendJsonDivision(String div_name){
        ...
        String url = "https://olmatix.com/wamonitoring/insert_employment.php";
        StringRequest MyStringRequest = new StringRequest(Request.Method.POST, url, response -> {
            Log.d(TAG, "onResponse: "+response);
            parsingJson(response);
            Log.d(TAG, "sendJsonLogin: "+response);
            ...
            protected Map<String, String> getParams() {
                Map<String, String> MyData = new HashMap<>();
                MyData.put("company_id", mCompanyID);
                MyData.put("employment_name", div_name);
    ...
    private class GetRecord extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(EmploymentActivity.this);
            pDialog.setMessage("Loading Employment names. Please wait...");
            pDialog.setCancelable(true);
            pDialog.setCanceledOnTouchOutside(false);
            pDialog.show();
        }
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            StringRequest MyStringRequest = new StringRequest(Request.Method.POST, url, response -> {
                ...
                try {
                    ...
                    String result_code = jObject.getString("success");
                    if (result_code.equals("1")) {
                    JSONArray cast = jsonResponse.getJSONArray("employment");
                        ...
                        ListAdapter adapter = new SimpleAdapter(
                                EmploymentActivity.this, divisionList,

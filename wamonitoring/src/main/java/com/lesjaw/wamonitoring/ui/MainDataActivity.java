...
public class MainDataActivity extends AppCompatActivity {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        mDataPagerAdaper.addFrag(data, "Daily");
        mDataPagerAdaper.addFrag(new LogUsers(), "Users");
        mDataPagerAdaper.addFrag(new LogByTag(), "Tags");
        mDataPagerAdaper.addFrag(data1, "Checklist");
